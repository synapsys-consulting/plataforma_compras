          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return new ResponsiveWidget (
                ...
                mediumScreen: _MediumScreen(widget.father, snapshot.data!, widget.userId, this._stateChangedAttr, widget.partnerId, widget.userRole),
...
class _MediumScreen extends StatefulWidget {
  ...
  final int partnerId;
  final String userRole;
  _MediumScreen (this.father, this.itemsPurchase, this.userId, this.stateChanged, this.partnerId, this.userRole);
